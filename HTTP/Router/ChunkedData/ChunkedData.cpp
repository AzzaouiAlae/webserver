...
// reads hex chars into _partialSize until \r\n, then converts and transitions to eParsingBody
// empty _partialSize + \n = trailing \r\n after a chunk body, silently skip
...
// copies up to _remaining bytes from r to w in-place, transitions to eParsingSize when done
