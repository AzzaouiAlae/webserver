...
string DeprecatedPath::joinPath(const string &root, const string &uri)
{
	if (root.empty())
		return uri;
	if (uri.empty())
...
void DeprecatedPath::checkFileExistence(const string &path)
{
	struct stat info;
...
void DeprecatedPath::checkPermissions(const string &path)
{
...
// --- The New Function ---
bool DeprecatedPath::emptyRoot() const
{
    // Returns true ONLY if both Server root AND Location root resulted in an empty string.
    return _root.empty();
}

string DeprecatedPath::encodePath(const string& path) {
...
string DeprecatedPath::decodePath(const string& path) 
{
    string decoded;
...
string DeprecatedPath::getFullPath() const { return _fullPath; }
string DeprecatedPath::getPathInfo() const { return _pathInfo; }
string DeprecatedPath::getCgiPath() const { return _cgiScriptPath; }
bool DeprecatedPath::isCGI() const { return _isCGI; }
bool DeprecatedPath::isDirectory() const { return _isDir; }
bool DeprecatedPath::isFile() const { return _isFile; }
bool DeprecatedPath::isFound() const { return _found; }
bool DeprecatedPath::hasPermission() const { return _hasPermission; }
bool DeprecatedPath::isRedirection() const { return _isRedir; }
string DeprecatedPath::getRedirCode() const { return _redirCode; }
string DeprecatedPath::getRedirPath() const { return _redirPath; }
