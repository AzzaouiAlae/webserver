...
DeprecatedTokenizing::DeprecatedTokenizing(string filepath): _filepath(filepath)
{
    openConfFile();
}

void DeprecatedTokenizing::openConfFile()
{
...
const vector<string>& DeprecatedTokenizing::get_tokens() const
{
    return (_tokens);
}

char DeprecatedTokenizing::shearch_delimiter(string& str, string delimiters)
{   
    size_t pos = 0;
...
void DeprecatedTokenizing::split_tokens()
{
